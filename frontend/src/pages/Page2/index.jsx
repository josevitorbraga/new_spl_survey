        ...
        <QuestionaryBox image={image}>
          <div className="option">
            ...
            <label className='radio-container' htmlFor="seg-a-quin">
              <input type="radio" name="page2" id="seg-a-quin" value='seg-a-quin' />
          ...
          <div className="option">
            ...
            <label className='radio-container' htmlFor="todos-dias">
              <input type="radio" name="page2" id="todos-dias" value='todos-dias' />
              <span className="checkmark"></span>
              Todos os dias
            </label>
          </div>
          ...
          <div className="option">
            ...
            <label className='radio-container' htmlFor="dom-e-feriados">
              <input type="radio" name="page2" id="dom-e-feriados" value='dom-e-feriados' />
              <span className="checkmark"></span>
              Domingos e feriados
            </label>
          </div>  
          ...
          <div className="option">
            ...
            <label className='radio-container' htmlFor="quando-necessario">
              <input type="radio" name="page2" id="quando-necessario" value='quando-necessario' />
              <span className="checkmark"></span>
          ...
          <div className="option">
            ...
            <label className='radio-container' htmlFor="sex-e-sab">
              <input type="radio" name="page2" id="sex-e-sab" value='sex-e-sab' />
              <span className="checkmark"></span>
              Sextas e sábados
            </label>
          </div>
